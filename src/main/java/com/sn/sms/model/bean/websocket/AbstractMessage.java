package com.sn.sms.model.bean.websocket;
...
import com.sn.sms.validator.deserializer.AnnotatedDeserializer;
...
public abstract class AbstractMessage {
	...
	public static RequestMessage convert(String json) throws JsonParseException {
		Gson gson = new GsonBuilder().registerTypeAdapter(RequestMessage.class, new AnnotatedDeserializer<>()).create();
